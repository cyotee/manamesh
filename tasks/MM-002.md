...
**Acceptance Criteria:**
- [ ] "Create Game" button generates WebRTC offer
- [ ] Offer encoded as compact, shareable string (base64 + compression)
- [ ] Copy button for easy sharing
- [ ] UI shows "Waiting for answer code..."
...
**Acceptance Criteria:**
- [ ] Text input for pasting offer code
- [ ] Automatic generation of answer code upon valid offer
- [ ] Copy button for answer code
...
**Acceptance Criteria:**
- [ ] Text input for answer code
- [ ] Connection established upon valid answer
- [ ] UI transitions to "Connected" state
- [ ] Data channel ready for game messages
...
- [ ] Two browser tabs on same machine can connect via join codes
- [ ] Two users on different networks can connect via join codes
- [ ] Codec tests pass
- [ ] Build succeeds
